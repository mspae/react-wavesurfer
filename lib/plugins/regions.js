...
/***/ function(module, exports, __webpack_require__) {
	...
	var Regions = function (_Component) {
	  ...
	  function Regions(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Regions).call(this, props));
	  ...
	  _createClass(Regions, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      try {
	        for (var _iterator = nextProps.regions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          newRegion = _step.value;
	          ...
	          if (!this.props.wavesurfer.regions.list[newRegion.id]) {
	            ...
	            // update regions
	          } else if (this.props.wavesurfer.regions.list[newRegion.id] && (this.props.wavesurfer.regions.list[newRegion.id].start !== newRegion.start || this.props.wavesurfer.regions.list[newRegion.id].end !== newRegion.end)) {
	      ...
	      try {
	        for (var _iterator2 = oldRegions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          oldRegion = _step2.value;
	    ...
	    value: function _init() {
	      ...
	      REGIONS_EVENTS.forEach(function (e) {
	        ...
	        var wavesurfer = _this3.props.wavesurfer;
	        if (propCallback) {
	          _this3._wavesurfer.on(e, function () {
	      ...
	      try {
	        for (var _iterator3 = this.props.regions[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          newRegion = _step3.value;
	    ...
	    value: function _hookUpRegionEvents(region) {
	      ...
	      REGION_EVENTS.forEach(function (e) {
	        ...
	        if (propCallback) {
	          _this4._wavesurfer.on(e, function () {
	...
	Regions.propTypes = {
	  ...
	  wavesurfer: _react.PropTypes.object.isRequired
	};
