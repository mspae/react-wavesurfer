	...
	var Regions = function (_Component) {
	  ...
	  _createClass(Regions, [{
	    ...
	    value: function _init() {
	      ...
	      for (var id in this.props.regions) {
	        if (this.props.regions.hasOwnProperty(id)) this._hookUpRegionEvents(this.props.wavesurfer.addRegion(this.props.regions[id]));
	      }
	    }
	  }, {
	    ...
	    value: function _hookUpRegionEvents(region) {
	      ...
	      REGION_EVENTS.forEach(function (e) {
	        var propCallback = _this3.props['onSingleRegion' + capitaliseFirstLetter(e)];
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      for (var regionId in nextProps.regions) {
	        if (nextProps.regions.hasOwnProperty(regionId)) {
	          var newRegion = nextProps.regions[regionId];
	          ...
	          if (!this.props.wavesurfer.regions.list[regionId]) {
	            ...
	            // update regions
	          } else if (this.props.wavesurfer.regions.list[regionId] && (this.props.wavesurfer.regions.list[regionId].start !== newRegion.start || this.props.wavesurfer.regions.list[regionId].end !== newRegion.end)) {
	      ...
	      for (var _regionId in oldRegions) {
	        if (oldRegions.hasOwnProperty(_regionId)) nextProps.wavesurfer.regions.list[_regionId].remove();
	      }
	    }
	  }, {
	    key: 'render',
